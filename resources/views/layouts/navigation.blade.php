<nav x-data="{ open: false }" class="bg-gradient-to-t from-indigo-50 to-indigo-100 border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    <!-- Settings Dropdown (Authenticated Users) -->
                ...
                @else
                    <!-- Login/Register Links (Guest Users) -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('topics.index')" :active="request()->routeIs('topics.index')">
                {{ __('Forum') }}
