                ...
                <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                    <form class="w-full">
                        ...
                        <div class="border border-gray-100 p-2 focus-within:ring-3 sm:flex sm:items-center sm:gap-4">
                            <input type="email" id="UserEmail" placeholder="yourEmail@email.com" class="w-full border-none focus:border-transparent focus:ring-transparent sm:text-sm">

                            <button class="mt-1 w-full rounded-md bg-indigo-600 px-6 py-3 text-sm font-bold tracking-wide text-white uppercase transition-none hover:bg-indigo-700 sm:mt-0 sm:w-auto sm:shrink-0">
                                Sign Up
                            </button>
                        </div>
                    </form>
