<x-app-layout>
    ...
    <div class="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <main class="flex-1 p-6 lg:p-8">
            ...
            <!-- Search Bar -->
                <x-search-bar name="Search topics..." route="dashboard.topics"></x-search-bar>
                                ...
                                <div class="px-6 py-4 hover:bg-gray-50 transition-colors">
                                    <div class="grid grid-cols-12 gap-4 items-center">
                                        ...
                                        <div class="col-span-2 text-center">
                                            <div
                                                class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 rounded-full">
                                                ...
                                                <span
                                                    class="font-semibold text-blue-700 text-sm">{{ $topic->replies_count }}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-span-2 text-center">
                                            <div
                                                class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-purple-50 rounded-full">
                                                ...
                                                <span
                                                    class="font-semibold text-purple-700 text-sm">{{ $topic->views }}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-span-3 flex justify-end gap-2">
                                            <x-edit-button
                                                href="{{ route('topics.edit', ['topic' => $topic, 'redirect' => 'dashboard']) }}">
                                                Edit
                                            </x-edit-button>
